          ...
          >
            <div className="w-full lg:w-1/2">
              ...
              <p className="text-gray-600 text-lg leading-relaxed mb-6">
                Welcome to our company, a leader in modern, sustainable agriculture. Our journey began with a simple idea: to harmonize farming practices with nature, ensuring that we give back to the earth as much as we take from it.
              </p>
        ...
        <div className="container mx-auto max-w-[1200px]">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                To create a global agricultural ecosystem where innovation meets sustainability, ensuring food security for future generations without compromising the planet's ecological balance.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                To empower farmers with cutting-edge technologies and sustainable practices, bridging the gap between nature and modern agriculture to cultivate a healthier, greener, and more prosperous world.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-[800px] text-center">
          ...
          >
            ...
            <div className="space-y-6 text-gray-600 text-lg leading-relaxed text-left">
              <p>
                What started as a small, family-owned farm has blossomed into a pioneering force in the agro-industry. We realized early on that traditional farming methods were taking a toll on the land we so deeply cherished.
              </p>
              <p>
