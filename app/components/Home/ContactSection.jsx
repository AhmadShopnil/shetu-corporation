      ...
      <div className="container mx-auto max-w-[1200px] relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-10">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-[50px] font-semibold text-gray-900 mb-6 leading-tight">
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-0 bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
          ...
          >
            ...
            <h3 className="text-3xl lg:text-4xl font-semibold mb-6 relative z-10">Contact Information</h3>
            <p className="text-base md:text-lg text-gray-400 mb-12 relative z-10 leading-relaxed">
            ...
            <div className="space-y-8 relative z-10">
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  <h4 className="text-lg md:text-xl font-semibold mb-1">Email</h4>
                  <p className="text-sm md:text-base text-gray-300">info@shetucorporation.com</p>
                </div>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-[#9DCC46] focus:border-transparent transition-all"
                    placeholder="John"
                  />
                </div>
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  required
                  rows="4"
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-[#9DCC46] focus:border-transparent transition-all resize-none"
