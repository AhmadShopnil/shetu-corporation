...
//             viewport={{ once: true }}
//             className="bg-[#DCE25A] hover:bg-[#c8d85b] text-gray-900 px-8 py-4 rounded-xl font-bold text-sm md:text-base flex items-center gap-2 
...
//                 <span className="text-6xl md:text-7xl font-bold text-gray-900 mb-2">{item?.percentage}</span>
